            ...
            <div class="card-body">
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="product_stock" class="form-control @error('product_stock') is-invalid @enderror" id="product_stock" value="{{ old('product_stock') }}" required>
                        @error('product_stock')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="picture" class="form-control @error('picture') is-invalid @enderror" id="picture" required>
                        @error('picture')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
